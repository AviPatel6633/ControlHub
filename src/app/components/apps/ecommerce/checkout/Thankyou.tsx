  ...
  return (
    <>
      ...
      <div className="sm:flex justify-between mt-6">
        <Button color={'success'} className="sm:mb-0 mb-4 sm:w-fit w-full rounded-md" href="/apps/ecommerce/shop">Continue Shopping</Button>
        <Button color={'primary'} className="sm:mb-0  sm:w-fit  w-full rounded-md">Download Receipt</Button>
      </div>
    </>
  );
};
