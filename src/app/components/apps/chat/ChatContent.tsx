                    ...
                    >
                      {selectedChat.id === msg.senderId ? (
                        <div className="flex gap-3">
                          ...
                          {msg.type === "text" ? (
                            <div>
                              <div className="text-xs text-bodytext dark:text-darklink font-semibold mb-1 block">
                                {selectedChat.name},{" "}
                              ...
                              <div className="p-2 bg-lightgray dark:bg-darkgray text-dark dark:text-white rounded-md">
                                {msg.msg}
                              </div>
                            </div>
                          ) : null}
                        ...
                        <div className="flex  justify-end w-full">
                          <div>
                            {msg.createdAt ? (
                              <div className="text-xs text-bodytext dark:text-darklink font-semibold mb-1 block text-end">
                                {formatDistanceToNowStrict(
                                  new Date(msg.createdAt),
                                  {
                                    addSuffix: false,
                            ...
                            {msg.type === "text" ? (
                              <div className="p-2 bg-lightinfo dark:bg-darkinfo text-dark dark:text-white rounded-md">
                                {msg.msg}
                              </div>
                            ) : null}
                            {msg.type === "image" ? (
